...
Public Class FormInputPenyewaan
    ...
    Private Sub FormInputPenyewaan_KeyDown(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles Me.KeyDown
        ...
        If e.KeyCode = Keys.F2 Then 'Jika Saya Tekan F2 view barang
            FS.FormShow(False, FormViewJasa, Me)
        End If
    End Sub
    ...
    Private Sub tKode_Barang_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles tKode_Jasa.KeyPress
        If e.KeyChar = Chr(13) Then
            If Not ckBarcode.Checked = True Then
                FS.FormShow(False, FormViewJasa, Me)
            Else
                '======
                If tId_Penyewaan.Text = "" Or tId_Pelanggan.Text = "" Or tNama_Pelanggan.Text = "" Or tKode_Jasa.Text = "" Then
                    MsgBox("Data belum lengkap", MsgBoxStyle.Exclamation, "Peringatan")
                Else
                    With DB
                        .Con.Close() : .Con.Open()
                        .Cmd = New MySqlCommand("SELECT * FROM TBL_JASA WHERE ID_JASA='" & tKode_Jasa.Text & "'", .Con)
                        .Rdr = .Cmd.ExecuteReader
                        .Rdr.Read()
                        If .Rdr.HasRows = True Then
                            tKode_Jasa.Text = .Rdr.GetString(0)
                            ...
                            If Not CInt(StokAkhir) <= 1 Then
                                If tId_Penyewaan.Text = "" Or tId_Pelanggan.Text = "" Or tNama_Pelanggan.Text = "" Or tKode_Jasa.Text = "" Or tNama_Barang.Text = "" Or tHarga_Jual.Text = "" Or tStok_Awal.Text = "" Then
                            ...
                            '==============================================================='
                        Else
                            INF.Pesan("Barang dengan kode [ " & tKode_Jasa.Text & " ] tidak ditemukan, silahkan input ke master barang", "Peringatan", "Informasi")
                            tKode_Jasa.Focus()
                        End If
                        .Rdr.Close()
                    End With
    ...
    Private Sub btnOke_Click(sender As System.Object, e As System.EventArgs) Handles btnOke.Click
        If tId_Penyewaan.Text = "" Or tId_Pelanggan.Text = "" Or tNama_Pelanggan.Text = "" Or tKode_Jasa.Text = "" Or tNama_Barang.Text = "" Or tHarga_Jual.Text = "" Then
            MsgBox("Data belum lengkap", MsgBoxStyle.Exclamation, "Peringatan")
        Else
            With DB
                .Con.Close() : .Con.Open()
    ...
    Private Sub SimpanPenjualan()
        ...
        DB.manipulasi("INSERT IGNORE INTO TBL_PENYEWAAN VALUES('" & tId_Penyewaan.Text & "', '" & tNama_Pelanggan.Text &
        ...
        Try
            With DB
                ...
                For i As Integer = 0 To DataGridInputPenjualan.Rows.Count - 2
                    ...
                    '===================================================================================
                    DB.manipulasi("Insert into tbl_penyewaan_dtl values ('" & IDPenjualan & "', '" & IDBarang &
    ...
    Private Sub tPembayaran_KeyPress(sender As Object, e As System.Windows.Forms.KeyPressEventArgs) Handles tPembayaran.KeyPress
        If e.KeyChar = Chr(13) Then
                ...
                Select Case cbStatusPiutang.SelectedIndex
                    Case 0 'tunai'
                        If Not CDbl(tKembalian.Text) < 0 Then
                            ...
                            Call FormTransaksiPenyewaan.RefreshDataPenjualan()
                            '===============================================
                            If ckBesarFaktur.Checked = True Then
                                FS.FormShow(False, FormStrukSewa, Me)
                            End If
                            '===============================================
                            Call IDPenjualan()
                            Call bersih()
