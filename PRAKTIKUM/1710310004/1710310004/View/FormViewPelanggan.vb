Public Class FormViewPelanggan
    ...
    Private Sub DataGridViewPelanggan_DoubleClick(sender As System.Object, e As System.EventArgs) Handles DataGridViewPelanggan.DoubleClick
        With DataGridViewPelanggan
            FormInputPenjualan.tId_Pelanggan.Text = .Item(0, .CurrentRow.Index).Value
            FormInputPenjualan.tNama_Pelanggan.Text = .Item(1, .CurrentRow.Index).Value
            Me.Close()
        End With
    End Sub

    Private Sub tPencarian_TextChanged(sender As System.Object, e As System.EventArgs) Handles tPencarian.TextChanged
